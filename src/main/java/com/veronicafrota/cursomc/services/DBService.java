...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		categoriaRepository.save(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));		// Saves the object in the database with repository.
		produtoRepository.save(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));	// Saves the object in the database with repository.
