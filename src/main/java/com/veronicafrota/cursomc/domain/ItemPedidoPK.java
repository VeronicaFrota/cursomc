...
// Auxiliary class to represent the identifier of the requested item, according to the modeling of the diagram
// To identify the ItemPedido  in the Produto and Pedido tables

@Embeddable				// To say that the class is a sub type, because this is called as a type in ItemPedido
